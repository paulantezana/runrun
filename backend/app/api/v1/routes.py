...
from app.api.v1.endpoints.thread import router as thread_router
from app.api.v1.endpoints.message import router as message_router

routers = APIRouter()
router_list = [auth_router, post_router, tag_router, user_router, thread_router, message_router]
